...
public enum RewordingType: String, CaseIterable, Identifiable, Sendable {
    ...
    case creativeRewrite = "creative_rewrite"
    case formalizeCasual = "formalize_casual"
    case casualizeFormal = "casualize_formal"
    case professionalize = "professionalize"
    ...
    public var displayName: String {
        ...
        case .formalizeCasual:
            return "Formalize Casual"
        case .casualizeFormal:
            return "Casualize Formal"
        case .professionalize:
            return "Professionalize"
        }
    }
    ...
    public var description: String {
        ...
        case .creativeRewrite:
            return "Completely rewrite text with creative flair and style"
        case .formalizeCasual:
            return "Transform casual language into formal, professional tone"
        case .casualizeFormal:
            return "Make formal text more casual and conversational"
        case .professionalize:
            return "Enhance text with professional language and structure"
        }
    }
}
